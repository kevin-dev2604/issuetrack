...
public class Keys {
    ...
    public static final UniqueKey<IssueFilesRecord> ISSUE_FILES_PKEY = Internal.createUniqueKey(IssueFiles.ISSUE_FILES, DSL.name("issue_files_pkey"), new TableField[] { IssueFiles.ISSUE_FILES.ID }, true);
    ...
    public static final UniqueKey<UploadFilesRecord> UPLOAD_FILES_PKEY = Internal.createUniqueKey(UploadFiles.UPLOAD_FILES, DSL.name("upload_files_pkey"), new TableField[] { UploadFiles.UPLOAD_FILES.FILE_ID }, true);
    ...
    public static final ForeignKey<IssueFilesRecord, IssueRecord> ISSUE_FILES__ISSUE_ISSUE_FILES_FK = Internal.createForeignKey(IssueFiles.ISSUE_FILES, DSL.name("issue_issue_files_fk"), new TableField[] { IssueFiles.ISSUE_FILES.ISSUE_ID }, Keys.ISSUE_PKEY, new TableField[] { Issue.ISSUE.ISSUE_ID }, true);
